...
import com.reign.framework.memorydb.BPlusTree;
...
public class BTreeIndexManager<V extends JdbcModel> implements IndexManager<V> {
    ...
    public V find(V value) {
        ...
        return (V) table.readByIdKey(idKey);
    }
    ...
    public List<V> leftFind(Object... args) {
        ...
        List<V> resultList = new ArrayList<>(keyList.size());
        for (String key:keyList){
            resultList.add((V)table.readByIdKey(key));
        }
        return resultList;
    }
